...
use TOT\Dependencies\Sentry\HttpClient\HttpClientInterface;
use TOT\Dependencies\Sentry\Integration\ErrorListenerIntegration;
use TOT\Dependencies\Sentry\Integration\IntegrationInterface;
use TOT\Dependencies\Sentry\Transport\TransportInterface;
use TOT\Dependencies\Symfony\Component\OptionsResolver\Options as SymfonyOptions;
use TOT\Dependencies\Symfony\Component\OptionsResolver\OptionsResolver;
...
final class Options
{
     ...
     *
     * @psalm-return null|callable(\TOT\Dependencies\Sentry\Tracing\SamplingContext): float
     */
     ...
     *
     * @psalm-param null|callable(\TOT\Dependencies\Sentry\Tracing\SamplingContext): float $sampler
     */
     ...
     *
     * @throws \TOT\Dependencies\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException
     * @throws \TOT\Dependencies\Symfony\Component\OptionsResolver\Exception\AccessException
     */
    private function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setAllowedTypes('integrations', ['TOT\\Dependencies\\Sentry\\Integration\\IntegrationInterface[]', 'callable']);
