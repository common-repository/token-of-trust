...
namespace TOT\Dependencies\Sentry\State;

use TOT\Dependencies\Psr\Log\NullLogger;
use TOT\Dependencies\Sentry\Breadcrumb;
use TOT\Dependencies\Sentry\CheckIn;
use TOT\Dependencies\Sentry\CheckInStatus;
use TOT\Dependencies\Sentry\ClientInterface;
use TOT\Dependencies\Sentry\Event;
use TOT\Dependencies\Sentry\EventHint;
use TOT\Dependencies\Sentry\EventId;
use TOT\Dependencies\Sentry\Integration\IntegrationInterface;
use TOT\Dependencies\Sentry\MonitorConfig;
use TOT\Dependencies\Sentry\Severity;
use TOT\Dependencies\Sentry\Tracing\SamplingContext;
use TOT\Dependencies\Sentry\Tracing\Span;
use TOT\Dependencies\Sentry\Tracing\Transaction;
use TOT\Dependencies\Sentry\Tracing\TransactionContext;
